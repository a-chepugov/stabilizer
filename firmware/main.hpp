...
State<int> state_crit_lo(0, 0, disconnect);

State<int> state_4(0, cfg::adc_ranges[0], connect_to_4);
State<int> state_5(cfg::adc_ranges[1], cfg::adc_ranges[2], connect_to_5);
State<int> state_6(cfg::adc_ranges[3], cfg::adc_ranges[4], connect_to_6);
State<int> state_7(cfg::adc_ranges[5], 0xFFFF);

State<int> state_crit_hi(0xFFFF, 0xFFFF, disconnect);
